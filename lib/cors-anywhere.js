...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['^https://[a-z0-9.]*.gravtee.com$', '^https://[a-z]*.+[a-z]*.gravty.io$', '^https://[a-z]*.+[a-z]*.gravty.info$', 'https://gravty.shoppersstop.net'],            // If non-empty, requests not from an origin in this list will be blocked.
