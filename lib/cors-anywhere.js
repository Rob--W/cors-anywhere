...
function isValidOrigin(origin) {
  return corsAnywhere.originWhitelist.forEach (x => origin.match(x));
}
...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['^https://[a-z]*.gravtee.com$', '^https://[a-z]*.+[a-z]*.gravty.io$', '^https://[a-z]*.+[a-z]*.gravty.info$', 'https://gravty.shoppersstop.net','westjet.demov2.gravtyshow.tech'],            // If non-empty, requests not from an origin in this list will be blocked.
