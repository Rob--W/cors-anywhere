...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    logRequests: false,             // Log every requests received
  ...
  return function(req, res) {
    ...
    if (location.host === 'requests' && corsAnywhere.logRequests) {
    ...
    req.corsAnywhereRequestState.logRequests = corsAnywhere.logRequests;
