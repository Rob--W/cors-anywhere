...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  if(!corsAnywhere.corsAnywhereRequestState.preserveSetCookie){
    // Strip cookies unless instructed to preserve
...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    preserveSetCookie: false,       // Preserve Set-Cookie headers in response (default is false)
  ...
  return function(req, res) {
    req.corsAnywhereRequestState = {
      ...
      preserveSetCookie: corsAnywhere.preserveSetCookie,
    };
