...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  // 1. Remove relevant headers.
  delete proxyRes.headers['x-frame-options'];
  // 2. Update relevant CSP. It's super unsafe careful.
  proxyRes.headers['Content-Security-Policy'] = "default-src 'self' 'unsafe-inline' 'unsafe-eval' *;";
